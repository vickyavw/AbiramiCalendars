        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 p-0">
                	<a href="/calendars?formatName=Normal Daily Calendars">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8">
                <ul class="filter__controls">
                    ...
                    <li data-filter=".CALENDAR">Calendars</li>
                    <li data-filter=".DIARY">Diaries</li>
                    <li data-filter=".BOX">Boxes</li>
                    <li data-filter=".LABEL">Labels</li>
                </ul>
            </div>
        </div>
        <div class="row property__gallery">
        	<c:forEach items="${products}" var="product">
	            <div class="col-lg-3 col-md-4 col-sm-6 mix ${product.productType}">
	                <div class="product__item">
	                    ...
	                    <div class="product__item__text">
	                        <h6><a href="/products?productType=${product.productType}&productId=${product.productId}&getRelated=4">${product.productName}</a></h6>
